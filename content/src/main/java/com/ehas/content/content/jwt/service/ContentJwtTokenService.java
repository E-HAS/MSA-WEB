package com.ehas.content.content.jwt.service;
...
@Slf4j
@Service
public class ContentJwtTokenService extends JwtTokenBase{
    public ContentJwtTokenService(JwtRedisSerivceImpt JwtRedisSerivceImpt) {
